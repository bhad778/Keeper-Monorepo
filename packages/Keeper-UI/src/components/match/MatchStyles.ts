...
export const useStyles = (isEmployee: boolean, isCandidateSort: boolean, color?: string, isNewMatch?: boolean) => {
  ...
  const styles = StyleSheet.create({
    ...
    avatar: {
      ...
      // opacity: isNewMatch ? 0.3 : 1,
      backgroundColor: isNewMatch ? color : theme.color.darkGrey,
      opacity: isNewMatch ? 0.3 : 1,
    },
