...
export const coreSignalResumeTransformer = (coreSignalUserData: TCoreSignalUserData) => {
  const updatedResume: TEmployeeSettings = {
    firstName: coreSignalUserData.first_name || 'empty',
    lastName: coreSignalUserData.last_name || 'empty',
    img: coreSignalUserData.logo_url || 'empty',
    address: coreSignalUserData.location || 'empty',
    aboutMeText: coreSignalUserData?.summary?.replace(/<\/[^>]+(>|$)/g, '') || 'empty',
    jobTitle: coreSignalUserData.title || 'empty',
    searchRadius: 50,
    employmentTypesOpenTo: [EmploymentTypeEnum.Salary, EmploymentTypeEnum.Contract],
    isUsCitizen: true,
    onSiteOptionsOpenTo: ['Remote', 'Hybrid', 'Office'],
    ...
    frontendBackendOptionsOpenTo: ['Full Stack', 'Only Frontend', 'Only Backend'],
...
// export const coreSignalJobTransformer = (brightDataJob: TBrightDataLinkedInJob) => {
//   const newJob: TJob = {
//     // coreSignal data
//     url: brightDataJob.url,
//     job_posting_id: brightDataJob.job_posting_id,
//     job_title: brightDataJob.job_title,
//     company_name: brightDataJob.company_name,
//     company_id: brightDataJob.company_id,
//     job_location: brightDataJob.job_location,
//     job_summary: brightDataJob.job_summary,
//     job_seniority_level: brightDataJob.job_seniority_level,
//     job_function: brightDataJob.job_function,
//     job_employment_type: brightDataJob.job_employment_type,
//     job_industries: brightDataJob.job_industries,
//     job_base_pay_range: brightDataJob.job_base_pay_range,
//     company_url: brightDataJob.company_url,
//     job_posted_date: brightDataJob.job_posted_date,
//     job_posted_time: brightDataJob.job_posted_time,
//     job_num_applicants: brightDataJob.job_num_applicants,
//     apply_link: brightDataJob.apply_link,
//     country_code: brightDataJob.country_code,
//     company_logo: brightDataJob.company_logo,

//     // devdog data
//     createdAt: new Date(),
//     requiredYearsOfExperience: BrightDataSeniorityEnum[brightDataJob.job_seniority_level],
//     skills: findContainedStrings(brightDataJob.job_summary, TechnologiesList),
