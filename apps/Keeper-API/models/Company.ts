...
import { normalizeLocation, normalizeUrl, normalizeCompanyName } from '../keeperApiUtils';
...
const CompaniesSchema = new mongoose.Schema({
  ...
  companyUUID: { type: String, default: null, required: false },
  ...
  foundedDate: { type: String, default: null, required: false },
  ...
  crunchbaseUrl: { type: String, default: null, required: false },
  interviewDifficulty: { type: String, default: null, required: false },
  contactEmail: { type: String, default: null, required: false },
  contactPhone: { type: String, default: null, required: false },
  socialMediaLinks: { type: Array, default: null, required: false },
